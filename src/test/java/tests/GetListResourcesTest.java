...
public class GetListResourcesTest {
    ...
    @Test
    @Story("Получение списка всех ресурсов и их полей")
    @Description("Получение полного списка всех доступных на сайте ресурсов с их значениями и полями. Ожидается приход полноценного JSON-ответа, со всеми полями")
    ...
    public void testSingleResource() throws Exception {
        ...
        step("Проверка значений полей с индексом ресурса = 0");
        ...
        step("Проверка значений полей с индексом ресурса = 6");
        ...
        step("Проверка значений полей с индексом ресурса = 11");
